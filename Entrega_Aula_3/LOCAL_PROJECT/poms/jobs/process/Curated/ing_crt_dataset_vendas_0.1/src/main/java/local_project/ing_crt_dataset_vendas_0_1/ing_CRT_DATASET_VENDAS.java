...
package local_project.ing_crt_dataset_vendas_0_1;
...
/**
 * Job: ing_CRT_DATASET_VENDAS Purpose: Ingestão do dataset de vendas<br>
 * Description: Gera o dataset de vendas <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class ing_CRT_DATASET_VENDAS implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ing_CRT_DATASET_VENDAS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ing_CRT_DATASET_VENDAS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ing_CRT_DATASET_VENDAS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS.length == 0) {
   					commonByteArray_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_ing_CRT_DATASET_VENDAS) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("D:/12ABD/Leandro/TOS_BD-20200219_1130-V7.3.1/workspace/out_Talend/Relatorios/ff_CRT_DATASET_VENDAS.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "D:/12ABD/Leandro/TOS_BD-20200219_1130-V7.3.1/workspace/out_Talend/ff_HRM_Sales.txt";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("D:/12ABD/Leandro/TOS_BD-20200219_1130-V7.3.1/workspace/out_Talend/ff_HRM_Sales.txt", "UTF-8",";","\n",false,1,0,
					...
					columnIndexWithD_tFileInputDelimited_1 = 17;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.SalesOrderDetailID = ParserUtils.parseTo_Integer(temp);
					...
					columnIndexWithD_tFileInputDelimited_1 = 18;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.OrderQty = ParserUtils.parseTo_Integer(temp);
					...
					columnIndexWithD_tFileInputDelimited_1 = 20;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.UnitPrice = ParserUtils.parseTo_Float(temp);
					...
					columnIndexWithD_tFileInputDelimited_1 = 21;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.UnitPriceDiscount = ParserUtils.parseTo_Float(temp);
					...
					columnIndexWithD_tFileInputDelimited_1 = 22;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.LineTotal = ParserUtils.parseTo_Float(temp);
...
if(row1 != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(row1.SalesOrderID != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.SalesOrderID
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.RevisionNumber != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.RevisionNumber
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.SalesOrderDetailID != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.SalesOrderDetailID
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.OrderQty != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.OrderQty
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.UnitPrice != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.UnitPrice
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.UnitPriceDiscount != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.UnitPriceDiscount
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.LineTotal != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.LineTotal
                        );
                            }
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("D:/12ABD/Leandro/TOS_BD-20200219_1130-V7.3.1/workspace/out_Talend/ff_HRM_Sales.txt") instanceof java.io.InputStream)){
 ...
 */
    ...
    public static void main(String[] args){
        final ing_CRT_DATASET_VENDAS ing_CRT_DATASET_VENDASClass = new ing_CRT_DATASET_VENDAS();

        int exitCode = ing_CRT_DATASET_VENDASClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ing_CRT_DATASET_VENDAS.class.getClassLoader().getResourceAsStream("local_project/ing_crt_dataset_vendas_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ing_CRT_DATASET_VENDAS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ing_CRT_DATASET_VENDAS");
        }
...
/************************************************************************************************
 *     76446 characters generated by Talend Open Studio for Big Data 
